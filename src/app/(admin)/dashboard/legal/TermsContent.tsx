  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Condiciones de Servicio</h1>
          <p className="text-sm text-gray-500">
            Normas y políticas que se muestran en la página pública de Condiciones de Servicio
          </p>
        </div>
        <a
          href="/condiciones"
      ...
      >
        ...
        <div>
          <label className={labelCls} htmlFor="content">
            Contenido de las Condiciones de Servicio
          </label>
          <textarea
            id="content"
            ...
            rows={18}
            placeholder="Escribe aquí las normas, políticas y condiciones de servicio…"
          />
          <p className={helpCls}>
            Usa <code>##</code> para títulos de sección y <code>-</code> para listas. Se interpreta
            como Markdown básico.
          </p>
        </div>
        ...
        {saved && (
          <p className="rounded-lg bg-green-50 px-3 py-2 text-sm text-green-600">
            Condiciones de servicio guardadas
          </p>
        )}
        ...
        >
          {saving ? "Guardando..." : "Guardar condiciones de servicio"}
        </button>
      </form>
    </div>
  );
